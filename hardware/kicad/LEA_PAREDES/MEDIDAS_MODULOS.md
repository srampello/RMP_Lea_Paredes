...
| Matek Micro BEC 6–30 V | 14,0 × 10,0 mm | 2,54 mm | Una hilera de 4 pads |
...
- Matek Micro BEC: vista de componentes hacia arriba y pads al lado izquierdo. De arriba hacia abajo: `5V_OUT`, `GND1`, `GND2`, `VIN_6-30V`. El puente `9V` debe permanecer abierto para obtener 5 V.
...
3. Confirmar el Matek con una impresión 1:1. Como sus cuatro pads están en un único lateral, sujetarlo además con una pequeña cantidad de silicona neutra o adhesivo flexible después de soldarlo.
4. Verificar con multímetro que el Matek entregue 5 V antes de instalar la ESP32-C3.
5. El AO3400 usa el SOT-23 estándar de KiCad: `Package_TO_SOT_SMD:SOT-23`, con 1=G, 2=S y 3=D.
